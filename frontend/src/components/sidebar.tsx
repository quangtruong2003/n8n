...
function NavLink({ item, collapsed }: { item: MenuItem; collapsed: boolean }) {
  ...
  return (
    ...
    >
      <span className={`shrink-0 ${isActive ? 'text-primary' : ''}`}>{ICONS[item.icon] || ICONS.home}</span>
    ...
    <>
      ...
      >
        <div className="flex items-center justify-between p-4 border-b shrink-0">
          ...
          <button onClick={onMobileClose} className="p-2 -mr-2 rounded-lg hover:bg-accent transition-colors">
        ...
        <div className="px-2.5 py-3 border-t shrink-0">
          <button onClick={onLogout} className="w-full flex items-center gap-3 rounded-lg text-[13px] font-medium text-red-500 hover:bg-red-50 px-3 py-2.5">
        ...
        <div className="shrink-0 border-t px-2.5 py-2 space-y-0.5">
          <div className="relative">
            <button
              ...
              className={`w-full flex items-center gap-3 rounded-lg text-[13px] font-medium text-red-500 hover:bg-red-50 transition-colors ${collapsed ? 'justify-center px-0 py-2' : 'px-3 py-2.5'}`}
            >
              <svg className="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0013.5 3h-6a2.25 2.25 0 00-2.25 2.25v13.5A2.25 2.25 0 007.5 21h6a2.25 2.25 0 002.25-2.25V15m3 0l3-3m0 0l-3-3m3 3H9" /></svg>
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 rounded-lg text-[13px] text-muted-foreground hover:bg-muted transition-all duration-150 ${collapsed ? 'justify-center px-0 py-2' : 'px-3 py-2.5'}`}
          >
            <svg className={`w-5 h-5 shrink-0 transition-transform duration-200 ${collapsed ? 'rotate-180' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M18.75 19.5l-7.5-7.5 7.5-7.5m-6 15L5.25 12l7.5-7.5" /></svg>
